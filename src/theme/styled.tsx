...
type IFunction = (data?: object) => object;
...
interface IProps {
  inheritFeeling?: boolean,
  withFeeling?: boolean,
  stripAttribute?: boolean,
  enumeratedAttributes?: object,
  passthroughProps?: string[],
  feelingOverrides?:(data?: object) => object,
  feelings?:(data?: any) => object,
  ghostTransform?:(data: IColorData, options?: any) => object,
}
...
export function styled(
  Component,
  {
    ...
    ghostTransform = ({ main, alt }: ColorData) => ({ main: alt, alt: main.alpha(0) }),
